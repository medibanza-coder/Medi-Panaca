          ...
          <div className="flex gap-3">
            ...
            >
              {isSaving ? (
                ...
                <><svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7" /></svg> Salvo</>
              ) : 'Salvar Revisão'}
            </button>
            <button 
              onClick={() => {
                          ...
                          <td className="px-6 py-3">
                            <div className="flex items-center gap-2">
                              ...
                              <button 
                                ...
                                className={`p-1.5 rounded-lg text-slate-200 hover:text-blue-600 hover:bg-blue-50 transition-all ${isListening === `${ind.id}-fullName` ? 'animate-pulse text-blue-600 bg-blue-50' : ''}`}
